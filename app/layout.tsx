  ...
  offers: [
    {
      ...
      price: '0',
      priceCurrency: 'USD',
      description: '5 generations per month, 3 of 7 content types, 1 project profile, community support',
    },
    {
      '@type': 'Offer',
      name: 'Pro',
      price: '49',
      priceCurrency: 'USD',
      description: 'Unlimited generations, all 7 content types, 5 project profiles, export PDF/Markdown, TokenForge AI import, priority email support. Annual billing: $39/month ($468/year).',
    },
    {
      '@type': 'Offer',
      name: 'Agency',
